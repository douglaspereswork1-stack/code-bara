        ...
        <div className="relative max-w-7xl mx-auto px-4 lg:px-6 py-8 lg:py-12 grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative lg:h-[520px] flex items-center justify-center">
            ...
            <div className="relative">
              <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 w-[420px] h-[120px] bg-[#22D3EE]/20 blur-3xl rounded-full pointer-events-none" />
              <div className="relative w-[360px] lg:w-[420px] h-[360px] lg:h-[420px] flex items-center justify-center">
                {/* boia */}
                <div className="absolute bottom-6 w-[320px] h-[120px] rounded-[50%] bg-gradient-to-br from-[#1E3A5F] to-[#0D1528] border border-[#22D3EE]/20 shadow-2xl" />
                <div className="absolute bottom-6 w-[320px] h-[40px] rounded-[50%] bg-[#22D3EE]/10 blur-xl" />
                <div className="relative flex flex-col items-center">
                  <Capybara size={180} />
                  <div className="mt-2 w-[180px] h-[110px] rounded-xl bg-[#0D1528] border border-[#22D3EE]/30 flex items-center justify-center shadow-lg">
                    <Code2 className="w-10 h-10 text-[#22D3EE]" />
                  </div>
                  <div className="absolute -right-6 bottom-10 hidden lg:block text-right">
                    <div className="text-[11px] font-bold text-[#22D3EE] leading-tight">Código<br />+<br />Foco<br />=<br />Liberdade</div>
